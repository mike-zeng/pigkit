...
func (proxy *HelloClientProxy) Hello(ctx context.Context, req *Request) (*Response, error) {
	resp, err := proxy.client.Call(ctx, req, proxy.options)
	if err != nil {
		return nil, err
	}
	serialization := codec.GetSerialization("proto")
	ret := Response{}
